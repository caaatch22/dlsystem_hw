...
def softmax_loss(Z, y_one_hot) -> ndl.Tensor(np.float32):
    ...
    """
    ### BEGIN YOUR SOLUTION
    return ((-y_one_hot * Z).sum() + ndl.log(ndl.exp(Z).sum(axes=1)).sum()) / Z.shape[0]
    ### END YOUR SOLUTION
